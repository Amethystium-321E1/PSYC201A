...
tea_data has 18 columns and tea_data_hignn has 48. Both datasets has two names of "condition" "rating"
...
Change sigma to 1, the shape of distribution stays the same. But it moved its center to 1.
...
Each dot represents one trial. The variation.
